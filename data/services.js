...
export const services = [
  {
    ...
    title: "Web Design",
    projects:
      "Studio grafico mirato per creare un design coerente con i servizi offerti e l’identità del brand.",
    animationOrder: "1",
  },
  {
    id: 2,
    icon: "fa-light fa-bezier-curve",
    title: "Sviluppo UI/UX",
    projects:
      "Realizzazione di interfacce utente intuitive e personalizzate, per un'esperienza coinvolgente.",
    animationOrder: "2",
  },

  {
    ...
    projects:
      "Strategie per migliorare la visibilità del sito sui motori di ricerca e attrarre traffico.",
    animationOrder: "3",
  },
  {
    id: 4,
    ...
    title: "Marketing",
    projects:
      "Pianificazione di campagne pubblicitarie, per risultati misurabili e un pubblico profilato.",
    animationOrder: "4",
  },
].map((elm) => {
  return {
